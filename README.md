...
* Clone the repository. git clone https://github.com/bigtammy1/AirBnB_clone.git
...
1. Github @ [Tammy Clinton](https://github.com/bigtammy1)
1. Github @ [Mukhtar Audu](https://github.com/Mukkhieyo)
